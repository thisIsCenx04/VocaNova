...
void main() {
  test(
    ...
    () async {
      ...
      final result = await QuizApiService(dio: dio).createSession(
        QuizConfigRequest(
          mode: 'timed',
          questionType: 2,
  ...
  test(
    ...
    () async {
      ...
      final result = await QuizApiService(
        dio: dio,
  ...
  test('finishSession posts to current backend endpoint', () async {
    ...
    await QuizApiService(dio: dio).finishSession(9);
  });
  ...
  test('loads quiz result with answer breakdown', () async {
    ...
    final result = await QuizApiService(dio: dio).getResult(9);
  ...
  test('loads paged wrong words and removes one', () async {
    ...
    final repository = QuizApiService(dio: dio);
