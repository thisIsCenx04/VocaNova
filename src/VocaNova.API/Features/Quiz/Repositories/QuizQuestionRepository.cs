...
public sealed class QuizQuestionRepository : IQuizQuestionRepository
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (maxWordId == 0)
        {
            return Array.Empty<QuizQuestionWordDto>();
        }
    ...
    private async Task<List<QuizQuestionWordDto>> FetchCandidatesAsync(
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (wordIds.Count == 0)
        {
            return new List<QuizQuestionWordDto>();
        }
    ...
    /// </summary>
    private static QuizQuestionWordDto? ToQuestionWord(
