...
public sealed class RedisKnnTopicRecommendationCache : IKnnTopicRecommendationCache
{
    ...
    public async Task<IReadOnlyCollection<TopicRecommendationDto>?> GetAsync(
        uint userId,
        CancellationToken cancellationToken = default)
    {
        ...
        return cached.HasValue
            ? JsonSerializer.Deserialize<IReadOnlyCollection<TopicRecommendationDto>>(cached!, JsonOptions)
            : null;
    }
